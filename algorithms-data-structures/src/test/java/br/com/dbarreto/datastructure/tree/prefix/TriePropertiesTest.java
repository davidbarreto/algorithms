...
/**
 * Property-based tests for {@link Trie} implementations.
 * <p>
 * These tests verify the correctness of Trie operations (add, remove, contains, etc.)
 * using randomized inputs generated by jqwik.
 */
class TriePropertiesTest {
    ...
    void shouldRetrieveAllWordsWithPrefix(
        ...
        Iterable<String> actual = trie.wordsWithPrefix(queryPrefix);
